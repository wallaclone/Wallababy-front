        ...
        <div>
            <Accordion>
                <Card>
                    ...
                    <Card.Body>
                    <input type="text" name="username" placeholder="Write your new username" onChange={handleChange}></input>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
                <Card>
                    ...
                    <Card.Body>
                        <input id="user_email" type="email" pattern="/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/" name="email" placeholder="Write your new email" onChange={handleChange}></input>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
                <Card>
                    ...
                    <Card.Body>
                        <input id="pass" type="password" name="password" placeholder="Write your new password" onChange={handleChange}></input>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
                <Card>
                    ...
                    <Accordion.Collapse eventKey="2">
                    <Card.Body>
                        <input id="confirm" type="password" name="confirm_password" placeholder="Write your new password" onChange={handleChange}></input>
                    </Card.Body>
                    </Accordion.Collapse>
                </Card>
