  ...
  return (
    <>
      <div className="m-3">
        <h2 className="titles">
          {' '}
          {props.intl.formatMessage({ id: 'myAdverts.title' })}
        </h2>
            ...
            <div className="card h-100">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  {' '}
                  { advert.status ? props.intl.formatMessage({ id: 'advertisement.typeBuy' }) : props.intl.formatMessage({ id: 'advertisement.typeSell' }) }
                </p>
                <p className="card-text">
                  <strong>
